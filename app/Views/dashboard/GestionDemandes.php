    ...
    <div class="card">
        <div class="header">
            ...
            <div class="filters" role="radiogroup" aria-label="Filtrer par statut (un seul à la fois)">
                ...
                <label class="check"><input type="radio" name="statusFilter" data-status="valide" <?= $status==='valide' ? 'checked' : '' ?>> <span>Validé</span></label>
                <label class="check"><input type="radio" name="statusFilter" data-status="termine" <?= $status==='termine' ? 'checked' : '' ?>> <span>Terminé</span></label>
            </div>
        </div>
